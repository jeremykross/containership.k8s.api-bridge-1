...
class KubernetesApi extends ApiImplementation {
    ...
    static k8sServiceDescriptionFor(appName, ports, discoveryPorts) {
    ...
    createService(appName, k8sPorts, discoveryPorts, cb) {

        const req = {
            uri: `${this.k8sApiUrl}/api/v1/namespaces/default/services`,
            method: 'POST',
            json: true,
            body: KubernetesApi.k8sServiceDescriptionFor(appName, k8sPorts, discoveryPorts)
        };
    ...
    createReplicatedPodFromApplications(appName, replicas, apps, cb) {
        ...
        console.log("Posting RC: " + JSON.stringify(replicationController));
    ...
    createApplication(csAppDesc, cb) {
        ...
        request({
            ...
            if(_.size(ports) === 0) {
                ...
                this.createService(appName, ports, [], ifSuccessfulResponse(handler));
            }
