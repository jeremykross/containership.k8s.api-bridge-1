...
>>>>>>> Added support for enforce_constraints.
    ...
    updateApplication(appId, csAppDesc, cb, shouldEnforceConstraints) {
        ...
        shouldEnforceConstraints = shouldEnforceConstraints || true; 
        ...
        return this.getApplications((err, apps) => {
            ...
            return request({
                ...
                if(shouldEnforceConstraints) {
                    this.enforceConstraints(newApp);
                }
    ...
    createApplication(csAppDesc, cb) {
        ...
        console.log("Posting K8S Description\n" + JSON.stringify(k8sAppDesc));
        ...
        return request({
            ...
            if(err || res.statusCode !== 201) {
                console.log("err: " + err + " RES: " + JSON.stringify(_.get(res, 'body', '{}')));
