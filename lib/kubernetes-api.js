...
class KubernetesApi extends ApiImplementation {
    ...
    static k8sServiceDescriptionFor(appName, ports, discoveryPorts, clusterIP) {
        return{
            kind: 'Service',
            metadata: {
    ...
    createService(appName, k8sPorts, discoveryPorts, clusterIP, cb) {
        ...
        const service_body = KubernetesApi.k8sServiceDescriptionFor(appName, k8sPorts, discoveryPorts);
    ...
    //K8S Only.
    createReplicatedPodFromApplications(appName, replicas, apps, cb) {
